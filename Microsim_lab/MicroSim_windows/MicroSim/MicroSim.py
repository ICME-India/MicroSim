...
#Noise Flag
    ...
    def clickedrunBtn(self):
        ...
        if self.radio_GP.isChecked():
            ...
            commandLine ="cd " + self.runDir + ";\\%userprofile%\MicroSim\Solvers\Grand_potential_Finite_difference_2D_serial\microsim_gp "  +self.infile.text()+" "+self.filling.text()+" "+self.output.text()
            os.system("start \"\" cmd /k \"cd "+self.runDir+"\"")
