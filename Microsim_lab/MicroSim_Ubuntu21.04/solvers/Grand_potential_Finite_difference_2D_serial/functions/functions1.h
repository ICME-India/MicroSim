...
void fill_phase_cube(struct fill_cube fill_cube_parameters, struct variables* gridinfo, long b);
// void fill_phase_circle (double radius, long x_center, long y_center, struct variables* gridinfo, long b);
void fill_phase_circle (struct fill_circle fill_circle_parameters, struct variables* gridinfo, long b);
void fill_phase_ellipse (struct fill_ellipse fill_ellipse_parameters, struct variables* gridinfo, long b);

// void fill_composition_cube(FILE *fp, long j, struct fill_cube* fill_cube_paramaters);
void fill_composition_cube(struct variables* gridinfo);
