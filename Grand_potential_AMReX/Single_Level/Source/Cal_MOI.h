...
void Cal_derM(int i, int j, int k, Array3D <Real, 0, AMREX_SPACEDIM*2, 0, compcount-2, 0, compcount-2, Order::C> &der_M, amrex::Array4<Real const> const& phi, Array3D <Real,0, phasecount-1, 0, compcount-2, 0, compcount-2, Order::C> der_cmu, Array3D <Real,0, phasecount-1, 0, compcount-2, 0, compcount-2, Order::C> diffs, int numcomp, int numphase){
