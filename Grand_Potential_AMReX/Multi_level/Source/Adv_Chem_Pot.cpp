...
void
AmrCoreGP::dmudt_2D(MultiFab& mu_new, MultiFab& mu_old, MultiFab& phi_new, MultiFab& phi_old, MultiFab& comp_new, MultiFab& comp_old, GpuArray<Real,AMREX_SPACEDIM> dx, amrex::Real dt, int lev)
{
	BL_PROFILE("dmudt()");
	#ifdef AMREX_USE_OMP
