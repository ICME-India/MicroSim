                         ...
                         double DELTA_X, double DELTA_Y, double DELTA_Z, double *Rot_mat, double *Inv_Rot_mat)
{
  ...
  double gradPhiMid[npha][5][3];
  double phiMid[npha][5];

  double qMid[npha][5][3], Rotated_qMid[npha][5][3];

  double ac[npha][5];
  double dadq[npha][5][3], Rotated_dadq[npha][5][3];
