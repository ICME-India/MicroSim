...
// #ifdef ISOTROPY
// double function_W_01_dwdphi(double *phi, double *divphi, struct gradlayer **gradient, int gidy, int a) {
//   int b,c;
//   double sum=0.0;
//   double phibphic;
...
// double function_W_01_dwdphi_smooth(double *phi, double *divphi, struct gradlayer **gradient, int gidy, int a) {
//   int b,c;
//   double sum=0.0;
//   //The normal obstacle potential
//   for (b=0; b < NUMPHASES; b++) {
...
// #ifdef ANISOTROPY
// double function_W_01_dwdphi(double *phi, double *divphi, struct gradlayer **gradient, int gidy, long a) {
